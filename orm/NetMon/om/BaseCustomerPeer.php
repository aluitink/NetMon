...
abstract class BaseCustomerPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Customerid', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('customerid', 'name', ),
        BasePeer::TYPE_COLNAME => array (CustomerPeer::CUSTOMERID, CustomerPeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CUSTOMERID', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('CustomerId', 'Name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Customerid' => 0, 'Name' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('customerid' => 0, 'name' => 1, ),
        BasePeer::TYPE_COLNAME => array (CustomerPeer::CUSTOMERID => 0, CustomerPeer::NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CUSTOMERID' => 0, 'NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('CustomerId' => 0, 'Name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CustomerPeer::CUSTOMERID);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CustomerPeer::CUSTOMERID) && $criteria->keyContainsValue(CustomerPeer::CUSTOMERID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CustomerPeer::CUSTOMERID);
            $value = $criteria->remove(CustomerPeer::CUSTOMERID);
            if ($value) {
                $selectCriteria->add(CustomerPeer::CUSTOMERID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CustomerPeer::CUSTOMERID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(CustomerPeer::DATABASE_NAME);
        $criteria->add(CustomerPeer::CUSTOMERID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CustomerPeer::DATABASE_NAME);
            $criteria->add(CustomerPeer::CUSTOMERID, $pks, Criteria::IN);
