...
/**
 * Base class that represents a row from the 'PluginSetting' table.
 *
 *
 *
 * @package    propel.generator.NetMon.om
 */
abstract class BasePluginSetting extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PluginSettingPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PluginSettingPeer
     */
    ...
    /**
     * The value for the pluginsettingid field.
     * @var        int
     */
    protected $pluginsettingid;
    ...
    /**
     * Get the [pluginsettingid] column value.
     *
     * @return int
     */
    public function getPluginsettingid()
    {
        return $this->pluginsettingid;
    }
    ...
    /**
     * Set the value of [pluginsettingid] column.
     *
     * @param int $v new value
     * @return PluginSetting The current object (for fluent API support)
     */
    public function setPluginsettingid($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->pluginsettingid !== $v) {
            $this->pluginsettingid = $v;
            $this->modifiedColumns[] = PluginSettingPeer::PLUGINSETTINGID;
        }
    ...
    public function setPluginid($v)
    {
        ...
        if ($this->pluginid !== $v) {
            $this->pluginid = $v;
            $this->modifiedColumns[] = PluginSettingPeer::PLUGINID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = PluginSettingPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PluginSettingPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PluginSetting object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PluginSettingPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PluginSettingQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PluginSettingPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PluginSettingPeer::PLUGINSETTINGID)) {
            $modifiedColumns[':p' . $index++]  = '`PluginSettingId`';
        }
        if ($this->isColumnModified(PluginSettingPeer::PLUGINID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `PluginSetting` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`PluginSettingId`':
                        $stmt->bindValue($identifier, $this->pluginsettingid, PDO::PARAM_INT);
                        break;
                    case '`PluginId`':
    ...
    {
        $pos = PluginSettingPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getPluginsettingid();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['PluginSetting'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PluginSetting'][$this->getPrimaryKey()] = true;
        $keys = PluginSettingPeer::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(PluginSettingPeer::DATABASE_NAME);
        $criteria->add(PluginSettingPeer::PLUGINSETTINGID, $this->pluginsettingid);
    ...
    /**
     * Generic method to set the primary key (pluginsettingid column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getPluginsettingid();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of PluginSetting (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setPluginsettingid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PluginSetting Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PluginSettingPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PluginSettingPeer();
        }
    ...
    public function getPlugin(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPlugin === null && ($this->pluginid !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPlugin->addPluginPluginSettings($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PluginSettingPeer::DEFAULT_STRING_FORMAT);
    }
