...
abstract class BaseGroup extends BaseObject implements Persistent
{
    ...
    public function setGroupid($v)
    {
        ...
        if ($this->groupid !== $v) {
            $this->groupid = $v;
            $this->modifiedColumns[] = GroupPeer::GROUPID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupPeer::GROUPID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupPeer::GROUPID)) $criteria->add(GroupPeer::GROUPID, $this->groupid);
    ...
    {
        $criteria = new Criteria(GroupPeer::DATABASE_NAME);
        $criteria->add(GroupPeer::GROUPID, $this->groupid);
    ...
    public function initGroupUsers($overrideExisting = true)
    {
        ...
        $this->collGroupUsers->setModel('UserGroup');
    }
    ...
    public function getGroupUsers($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collGroupUsers || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collGroupUsers) {
                ...
                $collGroupUsers = UserGroupQuery::create(null, $criteria)
                    ->filterByGroup($this)
                    ->find($con);
                if (null !== $criteria) {
     ...
     * @return Group The current object (for fluent API support)
     */
    public function addGroupUser(UserGroup $l)
    {
        if ($this->collGroupUsers === null) {
            $this->initGroupUsers();
            $this->collGroupUsersPartial = true;
