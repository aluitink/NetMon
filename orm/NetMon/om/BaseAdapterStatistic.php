...
/**
 * Base class that represents a row from the 'AdapterStatistic' table.
 *
 *
 *
 * @package    propel.generator.NetMon.om
 */
abstract class BaseAdapterStatistic extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AdapterStatisticPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AdapterStatisticPeer
     */
    ...
    /**
     * The value for the adapterstatisticid field.
     * @var        int
     */
    protected $adapterstatisticid;
    ...
    /**
     * Get the [adapterstatisticid] column value.
     *
     * @return int
     */
    public function getAdapterstatisticid()
    {
        return $this->adapterstatisticid;
    }
    ...
    /**
     * Set the value of [adapterstatisticid] column.
     *
     * @param int $v new value
     * @return AdapterStatistic The current object (for fluent API support)
     */
    public function setAdapterstatisticid($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->adapterstatisticid !== $v) {
            $this->adapterstatisticid = $v;
            $this->modifiedColumns[] = AdapterStatisticPeer::ADAPTERSTATISTICID;
        }


        return $this;
    } // setAdapterstatisticid()
    ...
    public function setAdapterid($v)
    {
        ...
        if ($this->adapterid !== $v) {
            $this->adapterid = $v;
            $this->modifiedColumns[] = AdapterStatisticPeer::ADAPTERID;
        }
    ...
    public function setInoctets($v)
    {
        ...
        if ($this->inoctets !== $v) {
            $this->inoctets = $v;
            $this->modifiedColumns[] = AdapterStatisticPeer::INOCTETS;
        }
    ...
    public function setOutoctets($v)
    {
        ...
        if ($this->outoctets !== $v) {
            $this->outoctets = $v;
            $this->modifiedColumns[] = AdapterStatisticPeer::OUTOCTETS;
        }
    ...
    public function setInpackets($v)
    {
        ...
        if ($this->inpackets !== $v) {
            $this->inpackets = $v;
            $this->modifiedColumns[] = AdapterStatisticPeer::INPACKETS;
        }
    ...
    public function setOutpackets($v)
    {
        ...
        if ($this->outpackets !== $v) {
            $this->outpackets = $v;
            $this->modifiedColumns[] = AdapterStatisticPeer::OUTPACKETS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->adapterstatisticid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = AdapterStatisticPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating AdapterStatistic object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AdapterStatisticPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AdapterStatisticQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AdapterStatisticPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = AdapterStatisticPeer::ADAPTERSTATISTICID;
        if (null !== $this->adapterstatisticid) {
        ...
        if ($this->isColumnModified(AdapterStatisticPeer::ADAPTERSTATISTICID)) {
            $modifiedColumns[':p' . $index++]  = '`AdapterStatisticId`';
        }
        if ($this->isColumnModified(AdapterStatisticPeer::ADAPTERID)) {
            $modifiedColumns[':p' . $index++]  = '`AdapterId`';
        }
        if ($this->isColumnModified(AdapterStatisticPeer::INOCTETS)) {
            $modifiedColumns[':p' . $index++]  = '`InOctets`';
        }
        if ($this->isColumnModified(AdapterStatisticPeer::OUTOCTETS)) {
            $modifiedColumns[':p' . $index++]  = '`OutOctets`';
        }
        if ($this->isColumnModified(AdapterStatisticPeer::INPACKETS)) {
            $modifiedColumns[':p' . $index++]  = '`InPackets`';
        }
        if ($this->isColumnModified(AdapterStatisticPeer::OUTPACKETS)) {
            $modifiedColumns[':p' . $index++]  = '`OutPackets`';
        }

        $sql = sprintf(
            'INSERT INTO `AdapterStatistic` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`AdapterStatisticId`':
                        $stmt->bindValue($identifier, $this->adapterstatisticid, PDO::PARAM_INT);
                        break;
                    case '`AdapterId`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AdapterStatisticPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AdapterStatisticPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getAdapterstatisticid();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['AdapterStatistic'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AdapterStatistic'][$this->getPrimaryKey()] = true;
        $keys = AdapterStatisticPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAdapterstatisticid(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setAdapterstatisticid($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setAdapterstatisticid($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdapterStatisticPeer::ADAPTERSTATISTICID)) $criteria->add(AdapterStatisticPeer::ADAPTERSTATISTICID, $this->adapterstatisticid);
        if ($this->isColumnModified(AdapterStatisticPeer::ADAPTERID)) $criteria->add(AdapterStatisticPeer::ADAPTERID, $this->adapterid);
        if ($this->isColumnModified(AdapterStatisticPeer::INOCTETS)) $criteria->add(AdapterStatisticPeer::INOCTETS, $this->inoctets);
        if ($this->isColumnModified(AdapterStatisticPeer::OUTOCTETS)) $criteria->add(AdapterStatisticPeer::OUTOCTETS, $this->outoctets);
        if ($this->isColumnModified(AdapterStatisticPeer::INPACKETS)) $criteria->add(AdapterStatisticPeer::INPACKETS, $this->inpackets);
        if ($this->isColumnModified(AdapterStatisticPeer::OUTPACKETS)) $criteria->add(AdapterStatisticPeer::OUTPACKETS, $this->outpackets);
    ...
    {
        $criteria = new Criteria(AdapterStatisticPeer::DATABASE_NAME);
        $criteria->add(AdapterStatisticPeer::ADAPTERSTATISTICID, $this->adapterstatisticid);
    ...
    /**
     * Generic method to set the primary key (adapterstatisticid column).
     *
    ...
    {
        $this->setAdapterstatisticid($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getAdapterstatisticid();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of AdapterStatistic (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setAdapterstatisticid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return AdapterStatistic Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AdapterStatisticPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AdapterStatisticPeer();
        }
    ...
    public function setAdapter(Adapter $v = null)
    {
        ...
        if ($v !== null) {
            $v->addAdapterAdapterStatistic($this);
        }
    ...
    public function getAdapter(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAdapter === null && ($this->adapterid !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAdapter->addAdapterAdapterStatistics($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(AdapterStatisticPeer::DEFAULT_STRING_FORMAT);
    }
