 ...
 *
 *
 * @method GroupQuery orderByGroupid($order = Criteria::ASC) Order by the GroupId column
 * @method GroupQuery orderByName($order = Criteria::ASC) Order by the Name column
 *
 * @method GroupQuery groupByGroupid() Group by the GroupId column
 ...
 *
 * @method array findByGroupid(int $GroupId) Return Group objects filtered by the GroupId column
...
abstract class BaseGroupQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'NetMon', $modelName = 'Group', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `GroupId`, `Name` FROM `Group` WHERE `GroupId` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(GroupPeer::GROUPID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(GroupPeer::GROUPID, $keys, Criteria::IN);
    }
     ...
     * $query->filterByGroupid(array('max' => 12)); // WHERE GroupId <= 12
     * </code>
     *
    ...
    public function filterByGroupid($groupid = null, $comparison = null)
    {
        if (is_array($groupid)) {
            ...
            if (isset($groupid['min'])) {
                $this->addUsingAlias(GroupPeer::GROUPID, $groupid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($groupid['max'])) {
                $this->addUsingAlias(GroupPeer::GROUPID, $groupid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupPeer::GROUPID, $groupid, $comparison);
    }
     ...
     */
    public function filterByGroupUser($userGroup, $comparison = null)
    {
        if ($userGroup instanceof UserGroup) {
            return $this
                ->addUsingAlias(GroupPeer::GROUPID, $userGroup->getGroupid(), $comparison);
            ...
            throw new PropelException('filterByGroupUser() only accepts arguments of type UserGroup or PropelCollection');
        }
    }
    ...
    /**
     * Use the GroupUser relation UserGroup object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
    ...
    public function useGroupUserQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'GroupUser', 'UserGroupQuery');
    }
    ...
    {
        if ($group) {
            $this->addUsingAlias(GroupPeer::GROUPID, $group->getGroupid(), Criteria::NOT_EQUAL);
        }
