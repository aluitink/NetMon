...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Userid', 'Name', 'Password', 'Emailaddress', 'Active', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userid', 'name', 'password', 'emailaddress', 'active', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USERID, UserPeer::NAME, UserPeer::PASSWORD, UserPeer::EMAILADDRESS, UserPeer::ACTIVE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USERID', 'NAME', 'PASSWORD', 'EMAILADDRESS', 'ACTIVE', ),
        BasePeer::TYPE_FIELDNAME => array ('UserId', 'Name', 'Password', 'EmailAddress', 'Active', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Userid' => 0, 'Name' => 1, 'Password' => 2, 'Emailaddress' => 3, 'Active' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userid' => 0, 'name' => 1, 'password' => 2, 'emailaddress' => 3, 'active' => 4, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USERID => 0, UserPeer::NAME => 1, UserPeer::PASSWORD => 2, UserPeer::EMAILADDRESS => 3, UserPeer::ACTIVE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USERID' => 0, 'NAME' => 1, 'PASSWORD' => 2, 'EMAILADDRESS' => 3, 'ACTIVE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('UserId' => 0, 'Name' => 1, 'Password' => 2, 'EmailAddress' => 3, 'Active' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UserPeer::USERID);
            $criteria->addSelectColumn(UserPeer::NAME);
            $criteria->addSelectColumn(UserPeer::PASSWORD);
            $criteria->addSelectColumn(UserPeer::EMAILADDRESS);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(UserPeer::USERID) && $criteria->keyContainsValue(UserPeer::USERID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(UserPeer::USERID);
            $value = $criteria->remove(UserPeer::USERID);
            if ($value) {
                $selectCriteria->add(UserPeer::USERID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UserPeer::USERID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(UserPeer::DATABASE_NAME);
        $criteria->add(UserPeer::USERID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(UserPeer::DATABASE_NAME);
            $criteria->add(UserPeer::USERID, $pks, Criteria::IN);
