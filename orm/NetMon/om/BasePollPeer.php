...
/**
 * Base static class for performing query and update operations on the 'Poll' table.
 *
 *
 *
...
abstract class BasePollPeer
{
    ...
    const DEVICEID = 'Poll.DeviceId';

    /** the column name for the SnmpPropertyId field */
    const SNMPPROPERTYID = 'Poll.SnmpPropertyId';

    /** the column name for the PluginId field */
    const PLUGINID = 'Poll.PluginId';
     ...
     * e.g. PollPeer::$fieldNames[PollPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Pollid', 'Deviceid', 'Snmppropertyid', 'Pluginid', 'Timestamp', 'Value', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('pollid', 'deviceid', 'snmppropertyid', 'pluginid', 'timestamp', 'value', ),
        BasePeer::TYPE_COLNAME => array (PollPeer::POLLID, PollPeer::DEVICEID, PollPeer::SNMPPROPERTYID, PollPeer::PLUGINID, PollPeer::TIMESTAMP, PollPeer::VALUE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('POLLID', 'DEVICEID', 'SNMPPROPERTYID', 'PLUGINID', 'TIMESTAMP', 'VALUE', ),
        BasePeer::TYPE_FIELDNAME => array ('PollId', 'DeviceId', 'SnmpPropertyId', 'PluginId', 'Timestamp', 'Value', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. PollPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Pollid' => 0, 'Deviceid' => 1, 'Snmppropertyid' => 2, 'Pluginid' => 3, 'Timestamp' => 4, 'Value' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('pollid' => 0, 'deviceid' => 1, 'snmppropertyid' => 2, 'pluginid' => 3, 'timestamp' => 4, 'value' => 5, ),
        BasePeer::TYPE_COLNAME => array (PollPeer::POLLID => 0, PollPeer::DEVICEID => 1, PollPeer::SNMPPROPERTYID => 2, PollPeer::PLUGINID => 3, PollPeer::TIMESTAMP => 4, PollPeer::VALUE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('POLLID' => 0, 'DEVICEID' => 1, 'SNMPPROPERTYID' => 2, 'PLUGINID' => 3, 'TIMESTAMP' => 4, 'VALUE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('PollId' => 0, 'DeviceId' => 1, 'SnmpPropertyId' => 2, 'PluginId' => 3, 'Timestamp' => 4, 'Value' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        $toNames = PollPeer::getFieldNames($toType);
        $key = isset(PollPeer::$fieldKeys[$fromType][$name]) ? PollPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PollPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PollPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PollPeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PollPeer::POLLID);
            $criteria->addSelectColumn(PollPeer::DEVICEID);
            $criteria->addSelectColumn(PollPeer::SNMPPROPERTYID);
            $criteria->addSelectColumn(PollPeer::PLUGINID);
            $criteria->addSelectColumn(PollPeer::TIMESTAMP);
            $criteria->addSelectColumn(PollPeer::VALUE);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PollPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PollPeer::DATABASE_NAME);
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PollPeer::$instances[$key])) {
                return PollPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (PollPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        PollPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to Poll
    ...
    {
        $key = PollPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = PollPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + PollPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PollPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinDevice(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PollPeer::DEVICEID, DevicePeer::DEVICEID, $join_behavior);
    ...
    public static function doCountJoinSnmpProperty(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PollPeer::SNMPPROPERTYID, SnmpPropertyPeer::SNMPPROPERTYID, $join_behavior);
    ...
    public static function doCountJoinPlugin(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PollPeer::PLUGINID, PluginPeer::PLUGINID, $join_behavior);
    ...
    /**
     * Selects a collection of Poll objects pre-filled with their Device objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinDevice(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PollPeer::addSelectColumns($criteria);
        $startcol = PollPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = PollPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = PollPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                PollPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Poll) to $obj2 (Device)
                $obj2->addDevicePoll($obj1);
    ...
    /**
     * Selects a collection of Poll objects pre-filled with their SnmpProperty objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Poll objects.
    ...
    public static function doSelectJoinSnmpProperty(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Poll) to $obj2 (SnmpProperty)
                $obj2->addSnmpPropertyPoll($obj1);
    ...
    /**
     * Selects a collection of Poll objects pre-filled with their Plugin objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Poll objects.
    ...
    public static function doSelectJoinPlugin(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Poll) to $obj2 (Plugin)
                $obj2->addPluginPoll($obj1);
    ...
    /**
     * Selects a collection of Poll objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PollPeer::addSelectColumns($criteria);
        $startcol2 = PollPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Poll) to the collection in $obj2 (Device)
                $obj2->addDevicePoll($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Poll) to the collection in $obj3 (SnmpProperty)
                $obj3->addSnmpPropertyPoll($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Poll) to the collection in $obj4 (Plugin)
                $obj4->addPluginPoll($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Poll objects pre-filled with all related objects except Device.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptDevice(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SnmpPropertyPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + SnmpPropertyPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = PollPeer::getInstanceFromPool($key1))) {
                ...
                $key2 = SnmpPropertyPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = SnmpPropertyPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (Poll) to the collection in $obj2 (SnmpProperty)
                $obj2->addSnmpPropertyPoll($obj1);
                ...
                // Add the $obj1 (Poll) to the collection in $obj3 (Plugin)
                $obj3->addPluginPoll($obj1);
    ...
    /**
     * Selects a collection of Poll objects pre-filled with all related objects except SnmpProperty.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Poll objects pre-filled with all related objects except Plugin.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(PollPeer::DATABASE_NAME)->getTable(PollPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BasePollPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BasePollPeer::TABLE_NAME)) {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(PollPeer::POLLID) && $criteria->keyContainsValue(PollPeer::POLLID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Poll or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PollPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(PollPeer::POLLID);
            $value = $criteria->remove(PollPeer::POLLID);
            if ($value) {
                $selectCriteria->add(PollPeer::POLLID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(PollPeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(PollPeer::TABLE_NAME, $con, PollPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            PollPeer::clearInstancePool();
            PollPeer::clearRelatedInstancePool();
            $con->commit();
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
        ...
        } elseif ($values instanceof Poll) { // it's a model object
            ...
            $criteria->add(PollPeer::POLLID, (array) $values, Criteria::IN);
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        return BasePeer::doValidate(PollPeer::DATABASE_NAME, PollPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(PollPeer::DATABASE_NAME);
        $criteria->add(PollPeer::POLLID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PollPeer::DATABASE_NAME);
            $criteria->add(PollPeer::POLLID, $pks, Criteria::IN);
