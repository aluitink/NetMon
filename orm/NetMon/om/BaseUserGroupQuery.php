...
abstract class BaseUserGroupQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'NetMon', $modelName = 'UserGroup', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `UserId`, `GroupId` FROM `UserGroup` WHERE `UserId` = :p0 AND `GroupId` = :p1';
        try {
    ...
    public function filterByUserid($userid = null, $comparison = null)
    {
        if (is_array($userid)) {
            $useMinMax = false;
            if (isset($userid['min'])) {
                $this->addUsingAlias(UserGroupPeer::USERID, $userid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userid['max'])) {
                $this->addUsingAlias(UserGroupPeer::USERID, $userid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByGroupid($groupid = null, $comparison = null)
    {
        if (is_array($groupid)) {
            ...
            if (isset($groupid['min'])) {
                $this->addUsingAlias(UserGroupPeer::GROUPID, $groupid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($groupid['max'])) {
                $this->addUsingAlias(UserGroupPeer::GROUPID, $groupid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(UserGroupPeer::USERID, $user->getUserid(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserGroupPeer::USERID, $user->toKeyValue('PrimaryKey', 'Userid'), $comparison);
        } else {
    ...
    public function filterByGroup($group, $comparison = null)
    {
        if ($group instanceof Group) {
            return $this
                ->addUsingAlias(UserGroupPeer::GROUPID, $group->getGroupid(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserGroupPeer::GROUPID, $group->toKeyValue('PrimaryKey', 'Groupid'), $comparison);
        } else {
