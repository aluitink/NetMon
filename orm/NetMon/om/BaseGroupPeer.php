...
abstract class BaseGroupPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Groupid', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('groupid', 'name', ),
        BasePeer::TYPE_COLNAME => array (GroupPeer::GROUPID, GroupPeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('GROUPID', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('GroupId', 'Name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Groupid' => 0, 'Name' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('groupid' => 0, 'name' => 1, ),
        BasePeer::TYPE_COLNAME => array (GroupPeer::GROUPID => 0, GroupPeer::NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('GROUPID' => 0, 'NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('GroupId' => 0, 'Name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(GroupPeer::GROUPID);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(GroupPeer::GROUPID) && $criteria->keyContainsValue(GroupPeer::GROUPID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.GroupPeer::GROUPID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(GroupPeer::GROUPID);
            $value = $criteria->remove(GroupPeer::GROUPID);
            if ($value) {
                $selectCriteria->add(GroupPeer::GROUPID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(GroupPeer::GROUPID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(GroupPeer::DATABASE_NAME);
        $criteria->add(GroupPeer::GROUPID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(GroupPeer::DATABASE_NAME);
            $criteria->add(GroupPeer::GROUPID, $pks, Criteria::IN);
